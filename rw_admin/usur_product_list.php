        ...
        <div class="block">  
			...
			<tbody>
				...
				<tr class="odd gradeX">
					...
					<td width="10%"><a href="updact_product.php?p_id=<?php echo $res_query['p_id']?>?&&view_id=<?php echo $res_query['p_id']?>">View</a> || <a href="del_product.php?del_usur_product_id=<?php echo $res_query['p_id']?>">Delete</a></td>
				</tr>
				<?php }}}}?>
			</tbody>
		</table>
